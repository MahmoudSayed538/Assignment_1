...
float fromHexToFloat(const string& hex);
...
class CU: CPU{
    public:
        ...
        void OR(string registerAdress , string registerAdress2 , string registerAdress3);
        void AND(string registerAdress , string registerAdress2 , string registerAdress3);
